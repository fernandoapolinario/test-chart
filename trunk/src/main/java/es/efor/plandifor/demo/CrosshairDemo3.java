...
public class CrosshairDemo3 extends ApplicationFrame
{
		...
		implements ChangeListener
	{
		...
		{
			TimeSeries timeseries = new TimeSeries("L&G European Index Trust", CrosshairDemo3.class$org$jfree$data$time$Month != null ? CrosshairDemo3.class$org$jfree$data$time$Month : (CrosshairDemo3.class$org$jfree$data$time$Month = CrosshairDemo3.class$("org.jfree.data.time.Month")));
			...
			TimeSeries timeseries1 = new TimeSeries("L&G UK Index Trust", CrosshairDemo3.class$org$jfree$data$time$Month != null ? CrosshairDemo3.class$org$jfree$data$time$Month : (CrosshairDemo3.class$org$jfree$data$time$Month = CrosshairDemo3.class$("org.jfree.data.time.Month")));
