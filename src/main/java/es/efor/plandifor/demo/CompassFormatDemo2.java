...
public class CompassFormatDemo2 extends ApplicationFrame
{
		...
		implements ChangeListener
	{
		...
		private XYDataset createDirectionDataset(int i)
		{
			...
			TimeSeries timeseries = new TimeSeries("Wind Direction", CompassFormatDemo2.class$org$jfree$data$time$Minute != null ? CompassFormatDemo2.class$org$jfree$data$time$Minute : (CompassFormatDemo2.class$org$jfree$data$time$Minute = CompassFormatDemo2.class$("org.jfree.data.time.Minute")));
		...
		{
			TimeSeriesCollection timeseriescollection = new TimeSeriesCollection();
			TimeSeries timeseries = new TimeSeries("Wind Force", CompassFormatDemo2.class$org$jfree$data$time$Minute != null ? CompassFormatDemo2.class$org$jfree$data$time$Minute : (CompassFormatDemo2.class$org$jfree$data$time$Minute = CompassFormatDemo2.class$("org.jfree.data.time.Minute")));
			Object obj = new Minute();
			double d = 3D;
			for (int j = 0; j < i; j++)
			{
